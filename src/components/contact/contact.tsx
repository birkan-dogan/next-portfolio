          ...
          <div>
            ...
            <div className="space-y-6 " style={{ animationDelay: "300ms" }}>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    <a href="tel:+905468503938" className="hover-underline">
                      +90 546 850 3938
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Ankara, Turkey</p>
                </div>
              </div>
            </div>
            ...
            >
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195884.29325944927!2d32.6488806!3d39.9333635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d347d520732db1%3A0xbdc57b0c0842b8d!2sAnkara%2C%20Turkey!5e0!3m2!1sen!2str!4v1704371234567!5m2!1sen!2str"
                loading="lazy"
