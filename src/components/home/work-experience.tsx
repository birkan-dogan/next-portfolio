...
const experiences = [
  {
    ...
    company: "Arasta International Technologies",
    location: "Ankara, TR",
    period: "2023 - Present",
    skills: [
      "React",
    ...
    description:
      "Contributed to the development of scalable web applications, collaborating with cross-functional teams to deliver high-quality software solutions.",
  },
  {
    id: 2,
    ...
    location: "Ankara, TR",
    period: "2022 - 2022",
    skills: ["HTML", "CSS", "JavaScript", "JQuery", "Bootstrap", "Magento"],
    description:
      "Developed and maintained the front-end of e-commerce websites, ensuring a seamless user experience and responsive design across devices.",
  },
  {
    id: 3,
