    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-4xl lg:text-9xl max-w-lg font-bold text-black-500 my-20 md:my-0 md:text-black-500 dark:text-gray-600 text-center">
            Favourite Projects
          </h1>
          <Link
            href="/projects"
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40 overflow-hidden">
          ...
          {/* Single card */}
          <a
            href="https://kubbella.vercel.app/"
